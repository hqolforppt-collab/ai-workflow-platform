...
Execute the /workflow-builder command for the story provided in the chat input
(`${input:story:Describe the feature, e.g. "Create Login and Registration Feature"}`).
