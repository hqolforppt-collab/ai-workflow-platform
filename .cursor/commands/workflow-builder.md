...
Turn the user story given after this command into a complete enterprise-grade
workflow blueprint YAML (28 sections, hidden-requirement discovery, maturity
levels L1-L6, default L6).
